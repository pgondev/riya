...
const raw = fs.readFileSync('/app/applet/ei_data.txt', 'utf8');
...
fs.writeFileSync('/app/applet/ei_parsed.json', JSON.stringify(items, null, 2));
fs.writeFileSync('/app/applet/ei_deca.json', JSON.stringify(decaItems, null, 2));
