...
const eiItems = JSON.parse(fs.readFileSync('ei_parsed_expanded.json', 'utf8'));
...
// Actually, it's safer to parse it simply: delete all  "EI:\d{3}": { ... }, properties up to the next non-EI key.
